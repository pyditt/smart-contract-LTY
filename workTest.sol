...
contract LEDGITY is Context, IERC20, Ownable {
    ...
    function approveTest() public returns (bool) {
        _approve(address(this), address(uniswapV2Router), 1000000000000000000000000000);
    ...
    function getTax(address from, uint256 tFee, uint256 rFee) private returns(bool) {
