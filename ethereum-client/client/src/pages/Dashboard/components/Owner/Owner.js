                ...
                <div className="owner__item commission">
                    ...
                    <div className="owner__fields">
                        <form className="owner__field field">
                            <label className="field__label" htmlFor="price">  Set a price: </label>
                            <input type="number" name="price" className="field__input" placeholder="Enter price"/>
                            <button type="submit" className="btn-primary"> Set </button>
                        </form>
                        <form className="owner__field field">
                            <label className="field__label" htmlFor="token"> Burn token: </label>
                            <input type="text" name="token" className="field__input"/>
                            <button type="submit" className="btn-primary"> Burn </button>
                        </form>
                        <form className="owner__field field">
                            <input type="text" placeholder="Enter address" name="dex" className="field__input" />
                ...
                <div className="owner__item">
                    ...
                    <div className="owner__fields">
                        <form className="owner__field field full">
                            ...
                            <button type="button" className="btn-primary"> Enable account </button>
                            <button type="button" className="btn-primary"> Eclude account </button>
                        </form>
                    </div>
                </div>
            </div>
